...
export default function DashboardPage() {
  ...
  const cardsData = [
    ...
    {
      title: "Total Revenue",
      value: `KES ${(stats?.total_sales_amount ?? 0).toLocaleString()}`,
      icon: ShoppingCart,
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {cardsData.map((card, idx) => (
          <Card
            key={idx}
            className="border border-green-500 shadow-sm bg-white hover:shadow-md transition-shadow"
          >
      ...
      <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-7">
        <Card className="col-span-4 border border-green-500 shadow-sm bg-white">
          <CardHeader>
